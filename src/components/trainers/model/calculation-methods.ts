...
import { CONTROL_CHART_METHODS } from './control-charts';
import { CPM_PERT_METHODS } from './cpm-pert';
...
import { PROCESS_CAPABILITY_METHODS } from './process-capability';
...
export const CALCULATION_TRAINER_METHODS: Readonly<Record<string, readonly string[]>> = {
  ...
  'cpm-pert': CPM_PERT_METHODS,
  'control-charts': CONTROL_CHART_METHODS,
  'process-capability': PROCESS_CAPABILITY_METHODS,
};
