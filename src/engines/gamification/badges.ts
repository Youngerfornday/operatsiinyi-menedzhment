...
export const BADGE_ACTIVITY_IDS = {
  ...
  workMeasurement: 'work-measurement',
...
export const BADGES: readonly BadgeDefinition[] = Object.freeze([
  ...
  {
    id: 'maidanchyk-obranyi',
    title: 'Майданчик обрано',
    condition: 'Оберіть майданчик методом вагових коефіцієнтів або центру ваги без жодної помилки',
    achievement: 'Обрали майданчик методом вагових коефіцієнтів або центру ваги без жодної помилки',
    topic: 't05',
    isEarned: flawless(BADGE_ACTIVITY_IDS.facilityLocation),
  },
  {
  ...
  {
    id: 'norma-vstanovlena',
    title: 'Норма встановлена',
    condition: 'Розрахуйте норму часу й норму виробітку за хронометражними даними без помилок',
    achievement: 'Розрахували норму часу й норму виробітку за хронометражними даними без помилок',
    topic: 't05',
    isEarned: flawless(BADGE_ACTIVITY_IDS.workMeasurement),
  },
  {
