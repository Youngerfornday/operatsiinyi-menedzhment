...
export interface AggregatePlanningVariant {
  readonly variantId: string;
  readonly method: AggregatePlanningMethod;
  /** Формулювання задачі без чисел — числа показані окремо у `given`, щоб скрінрідер читав їх як дані, а не як прозу. */
  readonly prompt: string;
  readonly given: readonly AggregatePlanningGivenItem[];
  readonly answers: readonly AggregatePlanningAnswerField[];
